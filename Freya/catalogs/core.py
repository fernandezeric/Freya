    ...
    def get_lc_deg_nearest(self):
        for catalog in self.catalogs:
            try :
                ...
                method_ = class_().get_lc_deg_nearest(self.ra,self.dec,self.radius,self.format)
                self.dataReturn[f'{catalog}'] = method_
            except :
                print(f'No find the catalog : {catalog}')
    ...
    def get_lc_hms_all(self):
        for catalog in self.catalogs:
            try :
                ...
                method_ = class_().get_lc_hms_all(self.hms,self.radius,self.format)
                self.dataReturn[f'{catalog}'] = method_
            except :
                print(f'No find the catalog : {catalog}')
    ...
    def get_lc_hms_nearest(self):
        for catalog in self.catalogs:
            try :
                ...
                method_ = class_().get_lc_hms_nearest(self.hms,self.radius,self.format)
                self.dataReturn[f'{catalog}'] = method_
            except :
                print(f'No find the catalog : {catalog}')
